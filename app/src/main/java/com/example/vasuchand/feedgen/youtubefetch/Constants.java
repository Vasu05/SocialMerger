...
public class Constants {
    ...
    public static final String DEFAULT_KEYWORD = "feed";
    ...
    public static final String UPLOAD_PLAYLIST = "PLkg-67mpSlAiZ_mhAi2g3JQ_Rm3SOFfjw";
    public static final String APP_NAME = "feedgen-145911";
}
